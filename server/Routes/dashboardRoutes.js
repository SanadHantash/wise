...
router.post('/dashboard/sendmessage/:id', dashboardController.sendmessagetouser);
...
router.get('/dashboard/course/:id/attendances/count', dashboardController.countattendances);
router.get('/dashboard/course/:id/attendances', dashboardController.attendances);
router.get('/dashboard/lesson/:id/viewers', dashboardController.videoviewers);
router.get('/dashboard/lesson/:id/viewers/count', dashboardController.countvideoviewers);
router.get('/dashboard/course/toprated', dashboardController.topratedcourse);
router.get('/dashboard/workshop/toprated', dashboardController.topratedworkshop);
...
router.get('/dashboard/workshop/minrated', dashboardController.minratedworkshop);
router.get('/dashboard/lessons/minrated',  dashboardController.minratedlesson);
router.get('/dashboard/course/mostenrolled', dashboardController.mostenrolledcourse);
router.get('/dashboard/workshop/mostenrolled', dashboardController.mostenrolledworkshop);
router.get('/dashboard/lessons/mostviewed',  dashboardController.mostviewedvideo);
